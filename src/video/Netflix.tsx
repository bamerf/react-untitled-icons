...
const Netflix = forwardRef<SVGSVGElement, CommonProps>(({ size = 24 }, ref) => (
  <svg
    ref={ref}
    width={size}
    height={size}
  ...
  >
    <path
      ...
      fill="url(#paint0_linear_4430_189431)"
    />
    <path
      ...
      fill="url(#paint1_linear_4430_189431)"
    />
    <path

...
const MSOutlook = forwardRef<SVGSVGElement, CommonProps>(
  ({ size = 24 }, ref) => (
    <svg
      ref={ref}
      width={size}
    ...
    >
      ...
      <rect
        ...
        height="28"
        rx="2"
        fill="url(#paint0_linear_4430_189465)"
      />
      ...
      >
        <path
          ...
          fill="url(#paint1_linear_4430_189465)"
        />
      </mask>
      <g mask="url(#mask0_4430_189465)">
        <path d="M32 14V18H30V14H32Z" fill="#135298" />
        <path d="M32 30V16L7 30H32Z" fill="url(#paint2_linear_4430_189465)" />
        <path d="M8 30V16L33 30H8Z" fill="url(#paint3_linear_4430_189465)" />
      </g>
      <path
      ...
      <rect
        ...
        height="18"
        rx="2"
        fill="url(#paint4_linear_4430_189465)"
      />
      <path

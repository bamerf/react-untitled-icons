...
const MSOneNote = forwardRef<SVGSVGElement, CommonProps>(
  ({ size = 24 }, ref) => (
    <svg
      ref={ref}
      width={size}
    ...
    >
      ...
      <path
        ...
        fill="url(#paint0_linear_4430_189464)"
      />
      <path
      ...
      <rect
        ...
        height="18"
        rx="2"
        fill="url(#paint1_linear_4430_189464)"
      />
      <path

...
const MSSharePoint = forwardRef<SVGSVGElement, CommonProps>(
  ({ size = 24 }, ref) => (
    <svg
      ref={ref}
      width={size}
    ...
    >
      <circle
        ...
        cy="11.5"
        r="9.5"
        fill="url(#paint0_linear_4430_189467)"
      />
      <circle cx="24" cy="17" r="8" fill="url(#paint1_linear_4430_189467)" />
      <mask
        id="mask0_4430_189467"
        mask-type="alpha"
      ...
      <g mask="url(#mask0_4430_189467)">
        <circle
          cx="16.5"
          cy="23.5"
          r="6.5"
          fill="url(#paint2_linear_4430_189467)"
        />
        <path
      ...
      <rect
        ...
        height="18"
        rx="2"
        fill="url(#paint3_linear_4430_189467)"
      />
      <path

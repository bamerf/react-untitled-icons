...
const MSYammer = forwardRef<SVGSVGElement, CommonProps>(
  ({ size = 24 }, ref) => (
    <svg
      ref={ref}
      width={size}
    ...
    >
      ...
      <rect
        ...
        height="18"
        rx="2"
        fill="url(#paint3_linear_4430_189469)"
      />
      <path

...
const GoogleDrive = forwardRef<SVGSVGElement, CommonProps>(
  ({ size = 24 }, ref) => (
    <svg
      ref={ref}
      width={size}
    ...
    >
      <g filter="url(#filter0_d_4430_189480)">
        <path
        ...
        />
        <path
          d="M20.0967 19.6783H26.9974C26.9628 20.4986 26.607 20.9779 26.607 20.9779L26.3475 21.4283C26.329 21.4547 26.3179 21.4698 26.3179 21.4698L25.7532 22.4611L24.4855 24.6677C24.4484 24.757 24.4052 24.8388 24.3595 24.9168C24.3422 24.9432 24.3261 24.9721 24.3076 24.9973C24.3026 25.0048 24.2977 25.0124 24.2927 25.0199C24.1358 25.2413 23.9604 25.4124 23.7849 25.547C23.6305 25.6628 23.5168 25.7169 23.5168 25.7169L20.0967 19.6783Z"
          fill="#EA4335"
        />
      </g>
      <defs>
        <filter
          id="filter0_d_4430_189480"
          x="-2"
          y="-1"
          width="36"
          height="36"
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_4430_189480"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_4430_189480"
            result="shape"
          />
        </filter>
      </defs>

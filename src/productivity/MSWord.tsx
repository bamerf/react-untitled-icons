...
const MSWord = forwardRef<SVGSVGElement, CommonProps>(({ size = 24 }, ref) => (
  <svg
    ref={ref}
    width={size}
    height={size}
  ...
  >
    ...
    <rect
      ...
      width="24"
      height="7"
      fill="url(#paint2_linear_4430_189463)"
    />
    <rect
      x="8"
      y="9"
      width="24"
      height="7"
      fill="url(#paint3_linear_4430_189463)"
    />
    <path
    ...
    <rect
      ...
      height="18"
      rx="2"
      fill="url(#paint4_linear_4430_189463)"
    />
    <path

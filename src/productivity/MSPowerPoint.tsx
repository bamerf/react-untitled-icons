...
const MSPowerPoint = forwardRef<SVGSVGElement, CommonProps>(
  ({ size = 24 }, ref) => (
    <svg
      width={size}
      height={size}
    ...
    >
      <circle cx="17" cy="16" r="14" fill="url(#paint0_linear_4430_189466)" />
      <mask
        id="mask0_4430_189466"
        mask-type="alpha"
      ...
      <g mask="url(#mask0_4430_189466)">
        <rect
          x="18"
          width="17"
          height="17"
          fill="url(#paint1_linear_4430_189466)"
        />
        <path
      ...
      <rect
        ...
        height="18"
        rx="2"
        fill="url(#paint2_linear_4430_189466)"
      />
      <path

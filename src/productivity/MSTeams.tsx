...
const MSTeams = forwardRef<SVGSVGElement, CommonProps>(({ size = 24 }, ref) => (
  <svg
    ref={ref}
    width={size}
    height={size}
  ...
  >
    <path
      ...
      fill="url(#paint0_linear_4430_189468)"
    />
    <path
      ...
      fill="url(#paint1_linear_4430_189468)"
    />
    <circle cx="27" cy="8" r="3" fill="#34439E" />
    <circle cx="27" cy="8" r="3" fill="url(#paint2_linear_4430_189468)" />
    <circle cx="18" cy="6" r="4" fill="url(#paint3_linear_4430_189468)" />
    <mask
      id="mask0_4430_189468"
      mask-type="alpha"
    ...
    >
      <path
        ...
        fill="url(#paint4_linear_4430_189468)"
      />
      <path
        ...
        fill="url(#paint5_linear_4430_189468)"
      />
    </mask>
    <g mask="url(#mask0_4430_189468)">
      <path

...
const GoogleMaps = forwardRef<SVGSVGElement, CommonProps>(
  ({ size = 24 }, ref) => (
    <svg
      ref={ref}
      width={size}
    ...
    >
      <g filter="url(#filter0_d_4430_189484)">
        <path
        ...
        />
        <path
          d="M12.4311 21.3422C12.4004 21.3074 12.3695 21.2723 12.3383 21.2368C11.1918 19.9342 9.67162 18.207 8.76855 16.2255L13.5439 10.8015C13.1387 11.3134 12.8976 11.9553 12.8976 12.6523C12.8976 14.3252 14.2865 15.6813 15.9997 15.6813C16.8675 15.6813 17.6521 15.3333 18.2151 14.7725L12.4311 21.3422Z"
          fill="#F9BB0E"
        />
        <path
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_4430_189484"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_4430_189484"
            result="shape"
          />
        </filter>
      </defs>

...
const ET = forwardRef<SVGSVGElement, CommonProps>(({ size = 24 }, ref) => (
  <svg
    ref={ref}
    width={size}
    height={size}
  ...
  >
    <g clipPath="url(#clip0_4430_187499)">
      <path
      ...
      />
      <path
        d="M11.9985 7.5564L13.0345 10.7449H16.3925L13.6748 12.7156L14.719 15.9136L11.9985 13.9336L9.2822 15.9099L10.3222 12.7156L7.60693 10.7449H10.9625L11.9985 7.5564Z"
        fill="#FFDA44"
      />
      <path

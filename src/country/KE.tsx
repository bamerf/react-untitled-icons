...
const Microsoft = forwardRef<SVGSVGElement, CommonProps>(
  ({ size = 24 }, ref) => (
    ...
    >
      <g clipPath="url(#clip0_4430_187539)">
        <path
        ...
        />
        <path
          d="M12.0002 24C7.24267 24 3.13192 21.2314 1.19092 17.2174H22.8094C20.8685 21.2314 16.7577 24 12.0002 24Z"
          fill="#496E2D"
        />
        <path

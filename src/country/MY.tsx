...
const Microsoft = forwardRef<SVGSVGElement, CommonProps>(
  ({ size = 24 }, ref) => (
    ...
    >
      <g clipPath="url(#clip0_4430_187555)">
        <path
          d="M12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24Z"
          fill="#F0F0F0"
        />
        <path
          d="M11.4785 12.0001H24.0002C24.0002 10.9169 23.8559 9.86778 23.5869 8.86963H11.4785V12.0001Z"
          fill="#D80027"
        />
        <path
          d="M11.4785 5.73861H22.239C21.5044 4.53992 20.5652 3.4804 19.4701 2.60815H11.4785V5.73861Z"
          fill="#D80027"
        />
        <path
          d="M12.0001 24C14.8243 24 17.4201 23.0239 19.47 21.3914H4.53027C6.58016 23.0239 9.17596 24 12.0001 24Z"
          fill="#D80027"
        />
        <path
          d="M1.76146 18.2601H22.2389C22.8286 17.2978 23.2859 16.2459 23.5868 15.1296H0.413574C0.714371 16.2459 1.17173 17.2978 1.76146 18.2601Z"
          fill="#D80027"
        />
        <path

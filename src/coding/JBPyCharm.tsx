...
const JBPyCharm = forwardRef<SVGSVGElement, CommonProps>(
  ({ size = 24 }, ref) => (
    <svg
      ref={ref}
      width={size}
    ...
    >
      <g clipPath="url(#clip0_4430_189506)">
        ...
        <path
          ...
          fill="url(#paint4_linear_4430_189506)"
        />
        <path

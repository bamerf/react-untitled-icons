...
const JBResharperCPlusPlus = forwardRef<SVGSVGElement, CommonProps>(
  ({ size = 24 }, ref) => (
    <svg
      ref={ref}
      width={size}
...
export default JBResharperCPlusPlus;

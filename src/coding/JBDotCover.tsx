...
const JBDotCover = forwardRef<SVGSVGElement, CommonProps>(
  ({ size = 24 }, ref) => (
    <svg
      ref={ref}
      width={size}
    ...
    >
      <g clipPath="url(#clip0_4430_189509)">
        ...
        <path
          ...
          fill="url(#paint1_linear_4430_189509)"
        />
        <path
          ...
          fill="url(#paint2_linear_4430_189509)"
        />
        <path

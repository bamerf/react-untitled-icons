...
const JBKotlin = forwardRef<SVGSVGElement, CommonProps>(
  ({ size = 24 }, ref) => (
    <svg
      width={size}
      height={size}
    ...
    >
      <path
        ...
        fill="url(#paint0_linear_4430_189524)"
      />
      <path
        d="M3 3H16.0433L3 16.75V3Z"
        fill="url(#paint1_linear_4430_189524)"
      />
      <path
        d="M16.0433 3L3 16.7367V29L16.0433 15.9567L29 3H16.0433Z"
        fill="url(#paint2_linear_4430_189524)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_4430_189524"
          x1="9.91557"
          y1="35.0727"
          x2="22.1997"
          y2="22.789"

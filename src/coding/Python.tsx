...
const Python = forwardRef<SVGSVGElement, CommonProps>(({ size = 24 }, ref) => (
  <svg
    ref={ref}
    width={size}
    height={size}
  ...
  >
    <path
      ...
      fill="url(#paint0_linear_4430_189528)"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      ...
      fill="url(#paint1_linear_4430_189528)"
    />
    <defs>
      <linearGradient
        id="paint0_linear_4430_189528"
        x1="12.4809"
        y1="2"
        x2="12.4809"
        y2="22.7407"

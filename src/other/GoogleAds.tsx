...
const GoogleAds = forwardRef<SVGSVGElement, CommonProps>(
  ({ size = 24 }, ref) => (
    <svg
      ref={ref}
      width={size}
    ...
    >
      ...
      />
      <path
        d="M12.6214 10.9171C11.5412 9.0306 12.1823 6.61829 14.0533 5.5291C15.9244 4.4399 18.317 5.08628 19.3973 6.97282L27.4757 21.0806C28.556 22.9671 27.9149 25.3794 26.0438 26.4686C24.1727 27.5578 21.7802 26.9114 20.6999 25.0249L12.6214 10.9171Z"
        fill="#4689F2"
      />
    </svg>
  )
